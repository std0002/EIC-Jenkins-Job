...
class TestCalculate(unittest.TestCase):
    ...
    def test_substract_method_returns_correct_result(self):
        ...
        self.assertEqual(-2, self.calc.substract(4, 6))
    ...
    def test_raiz_method_returns_correct_result(self):
        self.assertEqual(6, self.calc.raiz(36))
        self.assertEqual(2, self.calc.raiz(4))
        self.assertEqual(7, self.calc.raiz(49))

    def test_raiz_method_fails_with_negative_parameter(self):
        self.assertRaises(ValueError, self.calc.raiz, -10)
    ...
    def test_logaritmo_base10_fails_with_non_positive_parameter(self):
        self.assertRaises(ValueError, self.calc.logaritmo_base10, -10)
